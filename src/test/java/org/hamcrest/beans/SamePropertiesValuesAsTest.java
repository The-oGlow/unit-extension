...
public class SamePropertiesValuesAsTest extends AbstractMatcherTest {
    ...
    public void test_reports_mismatch_on_two_properties_difference() {
        ...
        assertMismatchDescription("intProperty was <3>", samePropertiesValuesAs(expectedBean), new ExampleBean("Notsame", 3, aValue));
